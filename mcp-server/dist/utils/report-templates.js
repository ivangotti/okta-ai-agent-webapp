 ...
 */
export function generateHTMLReport(data, reportType) {
...
function generateExecutiveHTML(data) {
    ...
    <section class="charts">
      ...
      <script>
        ...
        new Chart(ctx, {
          type: 'radar',
          data: {
            labels: ${JSON.stringify(functionSummary.map((f) => f.function_name))},
            datasets: [{
              label: 'Current Maturity',
              data: ${JSON.stringify(functionSummary.map((f) => f.avg_maturity))},
...
function generateTechnicalHTML(data) {
  ...
  `;
    ...
    <section class="compliance">
      ...
      <table>
        ...
        <tbody>
  `;
    complianceSummary.forEach((comp) => {
        html += `
      <tr>
