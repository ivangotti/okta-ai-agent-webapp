...
import { initializeInstanceManager, setupShutdownHandlers, removeLockFile } from './utils/instance-manager.js';
// Import new tools
...
import { startAssessmentWorkflow, StartAssessmentWorkflowSchema, checkAssessmentWorkflowStatus, CheckAssessmentWorkflowSchema } from './tools/comprehensive_assessment_workflow.js';
// Persistent Assessment Tool
import { persistentComprehensiveAssessment, persistentComprehensiveAssessmentTool, PersistentAssessmentSchema } from './tools/persistent_comprehensive_assessment.js';
// ============================================================================
// TOOL SCHEMAS
// ============================================================================
            ...
            switch (name) {
                ...
                case 'get_assessment': {
                    ...
                    if (!params.assessment_type || params.assessment_type === 'risks') {
                        data.risks = db.getRiskAssessments(profile.org_id);
                    }
                ...
                case 'track_progress': {
                    const result = await trackProgressTool.execute(args, db);
                    return {
                        content: [
                            {
                                type: 'text',
                ...
                case 'get_industry_benchmarks': {
                    const result = await getIndustryBenchmarksTool.execute(args, db);
                    return {
                        content: [
                            {
                                type: 'text',
                ...
                case 'generate_report': {
                    const result = await generateReportTool.execute(args, db);
                    return {
                        content: [
                            {
                                type: 'text',
                ...
                case 'compare_profiles': {
                    const result = await compareProfilesTool.execute(args, db);
                    return {
                        content: [
                            {
                                type: 'text',
                ...
                case 'export_data': {
                    const result = await exportDataTool.execute(args, db);
                    return {
                        content: [
                            {
                                type: 'text',
                ...
                case 'import_assessment': {
                    const result = await importAssessmentTool.execute(args, db);
                    return {
                        content: [
                            {
                                type: 'text',
                ...
                case 'validate_evidence': {
                    const result = await validateEvidenceTool.execute(args, db);
                    return {
                        content: [
                            {
                                type: 'text',
                ...
                case 'get_implementation_template': {
                    const result = await getImplementationTemplateTool.execute(args, db, framework);
                    return {
                        content: [
                            {
                                type: 'text',
                ...
                case 'generate_policy_template': {
                    const result = await generatePolicyTemplateTool.execute(args, db, framework);
                    return {
                        content: [
                            {
                                type: 'text',
                ...
                case 'get_assessment_questions': {
                    const result = await getAssessmentQuestions(args);
                    return {
                        content: [
                            {
                                type: 'text',
                ...
                case 'validate_assessment_responses': {
                    const result = await validateAssessmentResponses(args, db);
                    return {
                        content: [
                            {
                                type: 'text',
                ...
                case 'get_question_context': {
                    const result = await getQuestionContext(args);
                    return {
                        content: [
                            {
                                type: 'text',
                ...
                case 'reset_organizational_data': {
                    const result = await resetOrganizationalData(args);
                    return {
                        content: [
                            {
                                type: 'text',
