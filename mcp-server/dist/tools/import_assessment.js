...
export async function importAssessment(db, options) {
    try {
        ...
        const importResult = db.importAssessmentBatch(options.profile_id, assessments, options.conflict_mode || 'overwrite');
        return {
...
function parseExcelCSV(content) {
