...
function validateParams(params) {
    ...
    if (!params.subcategory_id)
        errors.push('subcategory_id is required');
...
async function getImplementationGuidance(params, db) {
    try {
        // Validate input
...
function generateGuidanceContent(subcategory, params) {
...
function generateImplementationSteps(_subcategoryId, approach) {
...
function generateTechnicalControls(_subcategoryId, organizationSize) {
    ...
    return [
        {
            ...
            complexity: organizationSize === 'small' ? 'medium' : 'high'
        },
        {
...
function generateAdministrativeControls(_subcategoryId) {
    return [
        {
...
function generatePhysicalControls(subcategoryId) {
...
function generateIndustryGuidance(_subcategoryId, sector) {
...
function generateSizeSpecificGuidance(_subcategoryId, size) {
    const sizeGuidance = {
        'small': {
...
function generateImplementationTimeline(_subcategoryId, size, _approach) {
    const baseDurations = {
    ...
    const duration = baseDurations[size] || baseDurations['medium'];
    return {
        phase_1: {
...
function generateSuccessMetrics(_subcategoryId) {
    return [
        {
...
function generateCommonPitfalls(_subcategoryId) {
    return [
        {
...
function getRelatedSubcategories(subcategoryId) {
    ...
    return relatedExamples[functionId] || [];
}
function generateReferences(_subcategoryId) {
    return [
        {
...
export const getImplementationGuidanceTool = {
