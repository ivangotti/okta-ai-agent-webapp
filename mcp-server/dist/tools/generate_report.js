...
import { generateHTMLReport, formatDataAsJSON } from "../utils/report-templates.js";
import * as fs from 'fs';
import * as path from 'path';
import * as os from 'os';
export async function generateReport(db, options) {
    try {
...
function estimatePageCount(htmlContent) {
