...
import { ALL_BENCHMARKS, INDUSTRY_METADATA } from "../data/industry-benchmarks.js";
export async function getIndustryBenchmarks(db, profile_id, industry, organization_size) {
    try {
        ...
        profileComparison.forEach((comp) => {
        ...
        const industryMeta = INDUSTRY_METADATA[industry] || {
            typical_frameworks: [],
            critical_functions: [],
            description: industry
        };
        // Generate recommendations
        const recommendations = generateRecommendations(avgOrgScore, avgIndustryScore, topQuartileGap, improvementAreas, industryMeta);
...
async function loadBenchmarkData(db, industry, organizationSize) {
    ...
    const relevantBenchmarks = ALL_BENCHMARKS.filter(b => b.industry === industry && b.organization_size === organizationSize);
...
function adjustBenchmarkForSize(benchmark, targetSize) {
...
function createDefaultBenchmarks(db, industry, organizationSize) {
...
function getPerformanceIndicator(orgScore, industryAvg) {
...
function estimatePercentile(score, benchmarks) {
...
function estimateRank(_score, sampleSize, percentile) {
    const percentileMap = {
        'Top 10%': 0.05,
        'Top 25%': 0.175,
        'Above Median': 0.4,
...
function generateRecommendations(orgScore, industryAvg, topQuartileGap, improvementAreas, industryMeta) {
...
function generateIndustryTrends(industry, _organizationSize) {
