 ...
 */
export async function getQuestionContext(params) {
 ...
 */
async function enhanceContextWithGuidance(context, params) {
    ...
    if (params.organization_context) {
        enhanced.contextualized_examples = generateContextualizedExamples(params.subcategory_id, params.organization_context.sector, params.organization_context.size);
    }
    return enhanced;
}
/**
 ...
 */
function generateRiskAssessmentGuidance(riskFactors) {
    return {
 ...
 */
function generateImplementationRoadmap(bestPractices, orgContext) {
    const phases = [
        {
 ...
 */
function generateContextualizedExamples(subcategoryId, sector, size) {
    const examples = {
        'GV.OC-01': {
            'healthcare': [
 ...
 */
function getAssessmentTips(subcategoryId) {
    const tipMap = {
        'GV.OC-01': [
 ...
 */
function getEvidenceSuggestions(_subcategoryId, orgContext) {
    const baseEvidence = [
 ...
 * Get common pitfalls
 */
function getCommonPitfalls(_subcategoryId) {
    return [
 ...
 */
function getMaturityIndicators(_subcategoryId) {
    return {
 ...
 */
function getComplexityLevel(subcategoryId) {
    const complexityMap = {
        'GV.OC-01': 'Medium',
        'GV.RM-01': 'High',
        'ID.AM-01': 'Medium',
 ...
 */
function getTypicalImplementationTime(subcategoryId, orgSize) {
    const baseTimeMap = {
        'GV.OC-01': {
            'small': '2-4 weeks',
            'medium': '1-2 months',
 ...
 */
function getRelatedFrameworks(subcategoryId) {
