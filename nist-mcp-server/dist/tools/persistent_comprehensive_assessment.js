 ...
 */
export async function persistentComprehensiveAssessment(params) {
 ...
 */
async function startNewAssessment(workflowId, progressManager) {
 ...
 */
async function resumeAssessment(workflowId, progressManager) {
 ...
 */
async function answerQuestion(params, progressManager) {
 ...
 */
async function getProgressStatus(workflowId, progressManager) {
    ...
    return {
        ...
        next_question: progressSummary.next_question ? {
            ...
            question_text: progressSummary.next_question.question_text,
            question_type: progressSummary.next_question.question_type,
            subcategory_id: progressSummary.next_question.subcategory_id,
            help_text: progressSummary.next_question.help_text
        } : undefined,
 ...
 */
async function pauseAssessment(workflowId, progressManager) {
