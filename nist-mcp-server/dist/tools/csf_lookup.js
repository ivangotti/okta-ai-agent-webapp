 ...
 */
export async function csfLookup(params) {
    try {
 ...
 */
function lookupFunctions(framework, functionId) {
    const results = [];
 ...
 */
function lookupCategories(framework, categoryId) {
    const results = [];
 ...
 */
function lookupSubcategories(framework, subcategoryId) {
    const results = [];
 ...
 */
function extractFunctionId(elementId) {
 ...
 */
function extractCategoryId(elementId) {
    // Format: GV.OC-01
