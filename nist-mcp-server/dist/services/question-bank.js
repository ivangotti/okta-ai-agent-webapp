...
export class QuestionBankService {
     ...
     */
    async getQuestionContext(params) {
        try {
     ...
     */
    async generateQuestionForSubcategory(subcategory, params) {
        try {
     ...
     */
    getFilteredSubcategories(params) {
        ...
        if (params.category) {
            subcategories = subcategories.filter(sub => sub.element_identifier.substring(0, sub.element_identifier.lastIndexOf('-')) === params.category);
        }
        return subcategories;
    }
    /**
     ...
     */
    generateQuestionText(subcategory, assessmentType) {
     ...
     */
    generateQuestionOptions(assessmentType, _orgSize) {
        switch (assessmentType) {
            case 'quick':
                return [
     ...
     */
    getQuestionType(assessmentType) {
        switch (assessmentType) {
            case 'quick':
     ...
     */
    getRelatedSubcategories(subcategoryId) {
     ...
     */
    getCommonChallenges(_subcategoryId, orgContext) {
     ...
     */
    getBestPractices(_subcategoryId, _orgContext) {
        return [
     ...
     */
    getSectorSpecificGuidance(_subcategoryId, sector) {
        const guidanceMap = {
     ...
     */
    getQuestionWeight(subcategoryId, orgSize) {
     ...
     */
    isQuestionRequired(subcategoryId, assessmentType) {
     ...
     */
    getConditionalLogic(_subcategoryId) {
     ...
     */
    customizeQuestionsForAssessmentType(questions, params) {
