 ...
 */
export function checkExistingInstance() {
    try {
        if (!fs.existsSync(LOCK_FILE)) {
            return null;
        }
        const lockData = fs.readFileSync(LOCK_FILE, 'utf-8');
        const instance = JSON.parse(lockData);
 ...
 */
export function terminateExistingInstance(instance) {
    try {
 ...
 */
export function setupShutdownHandlers(cleanup) {
 ...
 */
export function initializeInstanceManager(forceTerminate = false) {
