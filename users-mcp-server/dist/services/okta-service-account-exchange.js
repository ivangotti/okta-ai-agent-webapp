...
function redactServiceAccountResponse(data) {
...
let lastRevealableServiceAccount = null;
export function getLastRevealableServiceAccount() {
 ...
 * agent-a2a-chain.ts.
 */
export async function getServiceAccountCredential(subjectToken, options = {}) {
    ...
    logger.debug(`PAM service-account token exchange request (verbose)\n\n` +
    ...
    logger.debug(`PAM service-account token exchange response (verbose)\n\n${JSON.stringify(data, null, 2)}`);
