...
│  │  - Token Viewer  │    │  - Webapp Client ID: │    │  - Agent ID:         │         │
│  │  - User Profile  │    │    YOUR_WEBAPP_CLIENT... │    │    YOUR_AGENT...  │         │
│  └──────────────────┘    └──────────┬───────────┘    │  - Private Key JWT   │         │
│                                     │                 └──────────────────────┘         │
│                                     │                                                   │
│                      ┌──────────────┴──────────────┐                                   │
...
│           │  your-litellm-provider.com     │          │  localhost:8080  │                           │
│           └──────────────────┘          └──────────────────┘                           │
│                                                                                         │
└────────────────────────────────────────────────────────────────────────────────────────┘
                                     │
...
│                             │                  │                             │
│  your-okta-org.oktapreview    │                  │  .../oauth2/aus2o8ra5...    │
│  .com/oauth2/v1             │                  │                             │
│                             │                  │  Purpose:                   │
│  Used for:                  │                  │  - MCP audience validation  │
│  ────────────────────────   │                  │  - Scope: ask-nist-mcp     │
│  1. User Login (Step 1)     │                  │  - Audience: api://nist-    │
│     Client: YOUR_WEBAPP_CLIENT... │                  │    mcp-server               │
│     → ID Token              │                  │                             │
│     → Access Token          │                  │  NOT used for:              │
│                             │                  │  - User authentication      │
│  2. ID-JAG Exchange (Step 2)│                  │  - Token exchange           │
│     Agent: YOUR_AGENT... │                  │  (Only defines target)      │
│     Subject: User ID Token  │                  │                             │
│     → ID-JAG Token          │                  └─────────────────────────────┘
│     (oauth-id-jag+jwt)      │
│                             │
│  3. JWKS for Validation     │
│     /oauth2/v1/keys         │
│                             │
└─────────────────────────────┘
```
